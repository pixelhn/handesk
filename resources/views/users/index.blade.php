    ...
    <table class="striped">
        ...
        @foreach($users as $user)
            <tr>
                ...
                <td> <a href="{{ route('users.impersonate', $user) }}"> <i class="mdi mdi-key"></i> </a></td>
                <td> <a href="{{ route('users.destroy', $user) }}" class="delete-resource"> <i class="mdi mdi-delete"></i></a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
