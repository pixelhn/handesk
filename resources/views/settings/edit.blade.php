...
@section('content')
    ...
    <div class="description mt4">
        <table class="w50">
            <tr><td>Api token:</td><td> <span id="api-token">{{ config('handesk.api_token') }}</span> <button class="ml2" onclick="copyToClipboard('#api-token')"> <i class="mdi mdi-clipboard-outline"></i> Copy to clipboard</button></td></tr>
