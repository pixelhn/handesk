...
@section('content')
    ...
    <div class="comment new-comment">
        <table class="maxw600 no-padding">
            ...
            <tr><td> {{ __('idea.developmentEffort') }}</td><td><input class="slider" name="development_effort" type="range" min="0" max="10"></td></tr>
            <tr><td> {{ __('idea.salesImpact') }}</td><td><input class="slider" name="sales_impact" type="range" min="0" max="10"></td></tr>
            <tr><td> {{ __('idea.currentImpact') }}</td><td><input class="slider" name="current_impact" type="range" min="0" max="10"></td></tr>
